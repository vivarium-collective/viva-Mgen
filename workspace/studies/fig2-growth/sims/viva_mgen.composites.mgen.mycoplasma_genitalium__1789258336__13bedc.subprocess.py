...
try:
    ...
    _payload = {'spec_id': 'viva_mgen.composites.mgen.mycoplasma_genitalium', 'overrides': {}, 'run_id': 'viva_mgen.composites.mgen.mycoplasma_genitalium__1789258336__13bedc', 'db_file': '/Users/eranagmon/code/viva-mGen/workspace/studies/fig2-growth/runs.db', 'steps': 200, 'emit_paths': ['agents/0/stores/growth_fraction', 'agents/0/stores/growth_rate', 'agents/0/stores/mass', 'agents/0/stores/volume', 'stores/growth_fraction', 'stores/growth_rate', 'stores/mass', 'stores/volume'], 'default_emitter': 'xarray', 'max_generations': 3, 'single_daughters': False, 'zarr_store': '/Users/eranagmon/code/viva-mGen/workspace/studies/fig2-growth/runs.viva_mgen.composites.mgen.mycoplasma_genitalium__1789258336__13bedc.zarr'}
    ...
    try:
        ...
        _rfp.write_snapshot('/Users/eranagmon/code/viva-mGen/.pbg/runs/viva_mgen.composites.mgen.mycoplasma_genitalium__1789258336__13bedc', composite.state, ['agents/0/stores/growth_fraction', 'agents/0/stores/growth_rate', 'agents/0/stores/mass', 'agents/0/stores/volume', 'stores/growth_fraction', 'stores/growth_rate', 'stores/mass', 'stores/volume'])
    except Exception:
        pass
    from bigraph_schema.json_codec import BigraphJSONEncoder as _BJE
    print('@@@RESULTS@@@')
