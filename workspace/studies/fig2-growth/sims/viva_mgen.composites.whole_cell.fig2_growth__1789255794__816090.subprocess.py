...
try:
    ...
    _payload = {'spec_id': 'viva_mgen.composites.whole_cell.fig2_growth', 'overrides': {}, 'run_id': 'viva_mgen.composites.whole_cell.fig2_growth__1789255794__816090', 'db_file': '/Users/eranagmon/code/viva-mGen/workspace/studies/fig2-growth/runs.db', 'steps': 120, 'emit_paths': ['agents/0/derived (computed in sims/run/py from emitter output)', 'derived (computed in sims/run/py from emitter output)'], 'default_emitter': 'xarray', 'max_generations': 3, 'single_daughters': False, 'zarr_store': '/Users/eranagmon/code/viva-mGen/workspace/studies/fig2-growth/runs.viva_mgen.composites.whole_cell.fig2_growth__1789255794__816090.zarr'}
    ...
    try:
        ...
        _rfp.write_snapshot('/Users/eranagmon/code/viva-mGen/.pbg/runs/viva_mgen.composites.whole_cell.fig2_growth__1789255794__816090', composite.state, ['agents/0/derived (computed in sims/run/py from emitter output)', 'derived (computed in sims/run/py from emitter output)'])
    except Exception:
        pass
    from bigraph_schema.json_codec import BigraphJSONEncoder as _BJE
    print('@@@RESULTS@@@')
