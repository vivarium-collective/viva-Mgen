...
_FILES = [
    ...
    ("constant-provenance", "datasets/constant_provenance.json", "parameters",
     ...
     "generated by viva_mgen.provenance.audit_constants() / "
     "scripts/extract_constant_provenance.py. The transparency artifact for gap #5: "
     "see docs/CONSTANT_PROVENANCE.md for the tier tables."),
]
